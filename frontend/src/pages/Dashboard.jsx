...
const Dashboard = () => {
  ...
  const COLORS = ['#6366f1', '#8b5cf6', '#d946ef', '#f43f5e', '#f97316', '#eab308', '#0ea5e9', '#14b8a6'];
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 rounded-xl hover:bg-indigo-100 dark:hover:bg-indigo-800/50 transition-colors border border-indigo-200 dark:border-indigo-800 text-sm font-bold shadow-sm"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="relative z-10 p-6 h-full flex flex-col">
            <div className="flex justify-between items-start mb-8">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-2xl bg-indigo-50 dark:bg-indigo-900/30 flex items-center justify-center shadow-sm border border-indigo-100 dark:border-indigo-800/50 text-indigo-500 dark:text-indigo-400">
                  <FiZap size={32} />
                </div>
        ...
        <div className="card bg-white dark:bg-[#050505] rounded-[2.5rem] p-10 border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/30">
          <h2 className="text-2xl font-black mb-10 text-slate-900 dark:text-white tracking-tighter uppercase flex items-center gap-3">
            <div className="p-2 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-100 dark:border-indigo-800/30 shadow-sm"><FiPieChart size={24} className="text-indigo-500" /></div>
            Capital Bounds
          </h2>
          ...
          <div className="h-[280px] sm:h-[350px] w-full min-h-[280px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={lineChartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                />
                <Area type="monotone" dataKey="portfolioValue" stroke="#6366f1" strokeWidth={3} fillOpacity={1} fill="url(#colorNetWorth)" name="Net Worth" />
                <Area type="monotone" dataKey="investments" stroke="#a855f7" strokeWidth={3} fillOpacity={0.1} fill="none" name="Investments" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
